        ...
        {data.map((item) => {
          return (
            <Col
              ...
              md={{ span: 6, offset: 0 }}
              key={item.id}
              className="text-center p-2 product d-flex flex-column align-items-center "
            >
              <div
              ...
              <Link to={"product/" + item.id}>
                {" "}
                <h5 className="fs-5 py-2 product-title ">{item.title}</h5>
              </Link>
              <span style={{ fontSize: "8px" }} className="m-start">
