...
export default function ProductInfoJ({ allProducts, addproduct, myCart }) {
  ...
  function rating(rate) {
    ...
    if (rate > rated.length) {
      rated.push(
        <i className="fa-solid fa-star-half" style={{ color: "black" }}></i>
      );
    }
            ...
            <>
              ...
              <Col lg={6} sm={12} className="py-2 px-5 text-center">
                <h3 className="title py-3">
                  {theProduct.title} - ${theProduct.price}
                </h3>
                <span className="py-4 ">
                  {rating(theProduct.rating).map((item) => {
                    return <span key={Math.random()}>{item}</span>;
                  })}{" "}
                  - <span className="fw-bold"> {theProduct.rating} </span> -{" "}
                  {theProduct.raters} Total Ratings
                </span>
                    ...
                    <>
                      ...
                      {theProduct.categories.includes(51) ? (
                        <>
                          ...
                          <div>
                            <ul className="sizes d-flex justify-content-center gap-3">
                              {theProduct.sizing_Available.map((item) => {
                                return (
                                  <li
                          ...
                          <div style={{ fontSize: "11px" }}>
                            You Can Choose The Size After Adding the Product to
                            Your Cart
                          </div>
                        </>
                      ) : null}
                    ...
                    <>
                      <div>
                        <span className="d-block text-muted">
                          <i className="fa-solid fa-xmark"></i> Out of The Stock
                        </span>
                        <span
                        ...
                        >
                          {" "}
                          Sorry This Product Out of the Stock Now{" "}
                        </span>
                      </div>
                    </>
                  )}
                ...
                <div className="services  px-5">
                  ...
                  >
                    ...
                    <li>
                      <i className="fa-solid fa-box"></i> Free 30 Day Returns.
                    </li>
                    <li>
                      <i className="fa-solid fa-shield"></i> 2 Year Warranty
                    </li>
                  </ul>
                </div>
                <hr />
                  ...
                  <div className="materials py-2">
                    ...
                    <ul>
                      {theProduct.material.map((item) => {
                        return (
                          <li style={{ fontSize: "14px" }} key={Math.random()}>
