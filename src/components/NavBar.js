    ...
    <>
      <Navbar bg="light" expand="lg">
        <Container>
          ...
          <div className="sign">
            <Button variant="outline-dark " className="sign-up px-3 mx-2 fs-6">
              Sign-up
            </Button>
            <Button variant="outline-dark " className="sign-in px-3 mx-2 fs-6">
              Sign-in
            </Button>
          </div>
        </Container>
      ...
      <nav className="categories-links">
        <Container className="d-flex justify-content-around flex-wrap text-light text-center px-0">
          <NavLink
            className="p-2 fw-bold text-light flex-fill fs-6"
            to="electronics"
          >
            Electronics
          </NavLink>
