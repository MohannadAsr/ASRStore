    ...
    <section className="footer py-4">
      <Container>
        <Row className="g-0 ">
          <Col lg={3} className="p-4 ">
            ...
            <div className="text-light px-1">
              <div>
                <i className="fa-solid fa-location-dot px-2"></i>123 Street, New
                York,USA
              </div>
              <div>
                <i className="fa-solid fa-envelope  px-2"></i>mail@domain.com
              </div>
              <div>
                <i className="fa-solid fa-phone px-2"></i>+012 345 67890
              </div>
            </div>
          </Col>
          <Col lg={3} className="p-4 text-light">
            ...
            <ul className="py-4 ">
              <li className="py-2">
                <a href="/discover">
                  <i className="fa-solid fa-angle-right px-2"></i>Jewelery
                </a>
              </li>
              <li className="py-2">
                <i className="fa-solid fa-angle-right px-2"></i>Electronics
              </li>
            </ul>
          </Col>
          <Col lg={3} className="p-4 ">
            ...
            <ul className="py-4 text-light">
              <li className="py-2">
                <i className="fa-solid fa-angle-right px-2"></i>Home
              </li>
              <li className="py-2">
                <i className="fa-solid fa-angle-right px-2"></i>Discover
              </li>
              <li className="py-2">
                <i className="fa-solid fa-angle-right px-2"></i>Electronics
              </li>
        ...
        <div className="text-muted text-center">
          <div>© 2005-2022 ASRStore. All rights reserved.</div>
